"""Tests for bds_data_providers.sharpe_inference — Sharpe ratio statistical inference."""
...
class TestSharpeRatioVariance:
    ...
    def test_gaussian_case_reduces_to_lo_formula(self):
        """With gamma_3=0, gamma_4=3, rho=0, should match Lo (2002): (1 + SR^2/2) / T."""
        sr, t = 1.0, 252
...
class TestSharpeRatioPower:
    ...
    def test_power_near_zero_when_sr1_equals_sr0(self):
        """When true SR equals null, power is approximately alpha."""
...
class TestMultipleTesting:
    ...
    def test_holm_sidak_variant(self):
        ...
        # Sidak variant should be less conservative
