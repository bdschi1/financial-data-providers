"""Yahoo Finance data provider for MarketDataProvider (dict/pandas) ABC.
...
class YahooMarketProvider(MarketDataProvider):
    ...
    def get_company_overview(self, ticker: str) -> dict[str, Any]:
        """Get structured company overview from Yahoo Finance."""
        try:
    ...
    def get_price_data(self, ticker: str, period: str = "6mo") -> dict[str, Any]:
        """Get price data and performance metrics from Yahoo Finance."""
        try:
    ...
    def get_fundamentals(self, ticker: str) -> dict[str, Any]:
        """Get fundamental financial data from Yahoo Finance."""
        try:
            info = self.get_info(ticker)
            return {
                "ticker": ticker,
