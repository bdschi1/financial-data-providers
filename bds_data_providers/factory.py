"""Provider factory for the DataProvider (Polars) ABC.
...
Usage:
    from bds_data_providers.factory import get_provider, available_providers
...
# Each entry: (display_name, module_path, class_name, is_available_func_path)
_PROVIDER_REGISTRY: list[tuple[str, str, str, str | None]] = [
    ("Yahoo Finance", "bds_data_providers.yahoo", "YahooProvider", None),
    (
        "Bloomberg",
        "bds_data_providers.bloomberg",
        "BloombergProvider",
        "bds_data_providers.bloomberg.is_available",
    ),
    (
        "Interactive Brokers",
        "bds_data_providers.ib",
        "IBProvider",
