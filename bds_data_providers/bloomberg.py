"""Bloomberg Professional API data provider -- concrete implementation of DataProvider.
...
Merged from ls-portfolio-lab (session manager, safe helpers, error handling)
and backtest-lab (bid/ask support via BID/ASK fields).
...
class BloombergProvider(DataProvider):
    ...
    # Bloomberg field -> our column name (includes bid/ask)
    _DAILY_FIELDS = [
        "PX_OPEN", "PX_HIGH", "PX_LOW", "PX_LAST",
        "EQY_WEIGHTED_AVG_PX", "VOLUME", "BID", "ASK",
    ]
    ...
    def fetch_daily_prices(
        ...
        """Fetch daily OHLCV + bid/ask for multiple tickers.
                ...
                if msg.messageType() == blpapi.Name("HistoricalDataResponse"):
                    ...
                    for i in range(field_data.numValues()):
                        ...
                        frames.append({
                            ...
                            "bid": _safe_float(bar, "BID"),
                            "ask": _safe_float(bar, "ASK"),
                        })
    ...
    def _empty_price_df() -> pl.DataFrame:
        """Return an empty DataFrame with the standard price schema."""
        return pl.DataFrame(
            schema={
                "date": pl.Date,
                "ticker": pl.Utf8,
