...
Supports:
    ...
    - Bid/ask data via BID_ASK whatToShow

All methods return the same schema as YahooProvider.

Merged from ls-portfolio-lab (connection manager, readonly mode, duration
helper, pacing, ADJUSTED_LAST, contract qualification, XML parser) and
backtest-lab (bid/ask via _add_bid_ask method).
...
class IBProvider(DataProvider):
    ...
    Args:
        ...
        client_id: Client ID for this connection (default: 10).
    ...
    def fetch_daily_prices(
        ...
        """Fetch daily OHLCV + bid/ask bars from IB.
        ...
        try:
            frames = self._add_bid_ask(ib, frames, tickers, start, end)
