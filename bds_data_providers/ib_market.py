"""Interactive Brokers data provider for MarketDataProvider (dict/pandas) ABC.
...
Usage:
    ...
    provider = IBMarketProvider(port=7497)   # paper trading
...
class IBMarketProvider(MarketDataProvider):
    ...
    def get_price_data(self, ticker: str, period: str = "6mo") -> dict[str, Any]:
        """Get price data and performance metrics from IB."""
    ...
    def get_fundamentals(self, ticker: str) -> dict[str, Any]:
        """Get fundamental financial data from IB."""
        info = self._get_contract_info(ticker)
        return {
            "ticker": ticker,
    ...
    def get_quarterly_earnings(self, ticker: str) -> Any:
        """IB does not provide quarterly earnings data."""
        return None

    def get_history(self, ticker: str, period: str = "6mo") -> Any:
        """Return historical price DataFrame (pandas) from IB."""
        days = _period_to_days(period)
